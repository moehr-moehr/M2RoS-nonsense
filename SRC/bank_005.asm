...
if !def(COLOURHACK)
    ...
    gfx_titleScreen:     incbin "gfx/titleCredits/colour/titleScreen.chr",   0,$A00
    gfx_creditsFont:     incbin "gfx/titleCredits/colour/creditsFont.chr",   0,$300
    gfx_itemFont:        incbin "gfx/titleCredits/colour/itemFont.chr",      0,$200
    gfx_creditsNumbers:  incbin "gfx/titleCredits/colour/creditsNumbers.chr",0,$100

    ; 05:6F34
    gfx_creditsSprTiles: incbin "gfx/titleCredits/colour/creditsSprTiles.chr"
endc
